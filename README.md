...
Copyright (c) 2018, FreeHaven Protocol
...
FreeHaven is an experimental cryptocurrency that proposes a new way of achieving a stable fiat value storage while still having free reign to be traded at market value.


**Privacy:** FreeHaven uses a cryptographically sound system to allow you to send and receive funds without your transactions being easily revealed on the blockchain (the ledger of transactions that everyone has). This ensures that your purchases, receipts, and all transfers remain absolutely private by default.

**Security:** Using the power of a distributed peer-to-peer consensus network, every transaction on the network is cryptographically secured. Individual wallets have a 25 word mnemonic seed that is only displayed once, and can be written down to backup the wallet. Wallet files are encrypted with a passphrase to ensure they are useless if stolen.

**Untraceability:** By taking advantage of ring signatures, a special property of a certain type of cryptography, FreeHaven is able to ensure that transactions are not only untraceable, but have an optional measure of ambiguity that ensures that transactions cannot easily be tied back to an individual user or computer.

## About this project

This is the GUI for the [core FreeHaven implementation](https://github.com/freehavenprotocol/freehaven). It is open source and completely free to use without restrictions, except for those specified in the license agreement below. There are no restrictions on anyone creating an alternative implementation of FreeHaven that uses the protocol and network in a compatible manner.
...
2. Grab an up-to-date copy of the freehaven-gui repository

	`git clone https://github.com/freehavenprotocol/freehaven-gui.git`
...
3. Install [FreeHaven](https://github.com/freehavenprotocol/freehaven) dependencies:
...
6. Grab an up-to-date copy of the freehaven-gui repository
...
2. Install FreeHaven dependencies as described in [FreeHaven documentation](https://github.com/freehavenprotocol/freehaven) into msys2 environment
